...
Step actions represent the actions that can be performed during a simulation step,
such as the enforcement of boundary conditions, the application of external forces.
...
``Particle indirect control`` class
***********************************
