...
def run_sim():
    ...
    theModel = generateBoxKernelFunctionGrid(
        theModel,
        theJournal,
    ...
    theMaterial = {
        ...
        "properties": np.array([K, G, 1e9, 1e9, 1e0, 1e0, 1, 1e-7]),
    }
    ...
    dirchletBottom = ParticlePenaltyWeakDirichlet(
        "bottom", theModel, theModel.particleSets["box_grid_bottom"], "displacement", {0: 0, 1: 0, 2: 0}, 1e6
    )

    dirichlets = [dirchletBottom]
