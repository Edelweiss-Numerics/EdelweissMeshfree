...
from edelweissmeshfree.generators import circlempgenerator, rectangulargridgenerator
...
def run_sim():
    ...
    gmNeoHooke = {"material": "GMDAMAGEDSHEARNEOHOOKE", "properties": np.array([300.0, 0.3, 1.0, 2, 4, 1.4999, 1.0])}
