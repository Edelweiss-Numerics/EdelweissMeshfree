...
from edelweissmeshfree.particlemanagers.oldkdbinorganizedparticlemanager import (
...
def run_sim():
    ...
    theApproximation = MarmotMeshfreeApproximationWrapper("ReproducingKernel", dimension, completenessOrder=0)
